...
1. Run the script: `./SetDefaultAppsX.sh`

That's it! The script will automatically:
- Download and install swiftDialog if needed
- Download and install utiluti if needed
...
- **utiluti** - Will be automatically downloaded and installed if not present
...
Both dependencies are automatically installed with signature verification when you first run the script.
...
This should only happen if there's a network issue or the GitHub release is unavailable. Check your internet connection and try again. If the problem persists, you can manually install utiluti from: https://github.com/scriptingosx/utiluti
...
- **2.1** (2025-12-16)
  - Added automatic utiluti download and installation
  - Team ID signature verification for utiluti packages
  - Script now completely zero-dependency (no manual installations required)
